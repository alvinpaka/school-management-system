    ...
    <Sidebar>
        <template #header-title>
            <div class="flex items-center gap-2">
                ...
                <span class="font-black text-sm uppercase tracking-wider text-warm-muted dark:text-dark-muted">Course Intelligence</span>
            </div>
        </template>
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <span class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Code: #{{ subject.code }}</span>
                            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="card-warm rounded-[3rem] overflow-hidden">
                        ...
                        <div class="p-8">
                            <div class="prose prose-slate dark:prose-invert max-w-none">
                                <p class="text-lg text-warm-muted dark:text-dark-muted leading-relaxed font-medium">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                                    <div class="p-6 rounded-[2rem] bg-terracotta/5 border border-terracotta/20">
                                        <div class="flex items-center gap-4 mb-4">
                                            ...
                                            <h4 class="font-black text-warm-text dark:text-dark-text uppercase tracking-tighter">Learning Objectives</h4>
                                        </div>
                                        <ul class="space-y-2 text-sm text-warm-muted dark:text-dark-muted font-bold">
                                    ...
                                    <div class="p-6 rounded-[2rem] bg-terracotta/5 border border-terracotta/20">
                                        <div class="flex items-center gap-4 mb-4">
                                            ...
                                            <h4 class="font-black text-warm-text dark:text-dark-text uppercase tracking-tighter">Assessment Method</h4>
                                        </div>
                                        <p class="text-sm text-warm-muted dark:text-dark-muted font-bold">
                ...
                <div class="space-y-8">
                    <div class="card-warm rounded-[3rem] p-8">
                        <h3 class="text-xl font-black text-warm-text dark:text-dark-text tracking-tighter mb-8 bg-terracotta/5 rounded-xl px-4 py-1 inline-block">Course Metrics</h3>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-terracotta/5 border border-terracotta/20 group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Course Code</p>
                                        <p class="text-sm font-black text-warm-text dark:text-dark-text">{{ subject.code }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-terracotta/5 border border-terracotta/20 group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Credit Load</p>
                                        <p class="text-sm font-black text-warm-text dark:text-dark-text">{{ subject.credits || 3 }} Units</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-terracotta/5 border border-terracotta/20 group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Student Enrollment</p>
                                        <p class="text-sm font-black text-warm-text dark:text-dark-text">124 Enrolled</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Faculty / Mentor -->
                    <div class="card-warm rounded-[3rem] p-8">
                        <h3 class="text-xl font-black text-warm-text dark:text-dark-text tracking-tighter mb-6">Principal Mentor</h3>
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h4 class="text-lg font-black text-warm-text dark:text-dark-text leading-none mb-1">Dr. Alex Rivers</h4>
                                <p class="text-xs font-bold text-warm-muted dark:text-dark-muted uppercase tracking-wider">Senior Academic Lead</p>
                            </div>
                        </div>
                    </div>
                </div>

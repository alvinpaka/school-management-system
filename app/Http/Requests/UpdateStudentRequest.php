...
class UpdateStudentRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        \Log::info('UpdateStudentRequest incoming data:', $this->all());
        
        // Convert gender to lowercase for consistent validation
        if ($this->gender) {
            $this->merge(['gender' => strtolower($this->gender)]);
        }
        
        // Convert status to lowercase for consistent validation
        if ($this->status) {
        ...
        // Debug: Log data after preparation
        \Log::info('UpdateStudentRequest after prepareForValidation:', $this->all());
    }
}

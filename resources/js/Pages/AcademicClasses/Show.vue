    ...
    <Sidebar>
        <template #header-title>
            <div class="flex items-center gap-2">
                ...
                <span class="font-black text-sm uppercase tracking-wider text-warm-muted dark:text-dark-muted">Class Intelligence</span>
            </div>
        </template>
        ...
        <div class="space-y-8 animate-fade-in-up">
                    ...
                    <div class="flex items-center gap-8">
                        ...
                        <div>
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <span class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Section: 104-A</span>
                            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <!-- Sections Grouping -->
                    <div>
                        <h3 class="text-xl font-black text-warm-text dark:text-dark-text uppercase tracking-tighter mb-4 px-2">Assigned Sections</h3>
                            ...
                            >
                                ...
                                <div class="flex items-center justify-between relative z-10">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h4 class="text-xl font-black text-warm-text dark:text-dark-text tracking-tight">{{ section.name }}</h4>
                                            <p class="text-xs font-bold text-warm-muted dark:text-dark-muted uppercase tracking-widest">Enrollment: 42 Students</p>
                                        </div>
                                    </div>
                        ...
                        <div v-else class="card-warm p-12 rounded-[2rem] text-center">
                            ...
                            <p class="text-warm-muted dark:text-dark-muted font-bold uppercase tracking-widest italic">No sections initialized for this class</p>
                        </div>
                    </div>
                ...
                <div class="space-y-8">
                    <div class="card-warm rounded-[3rem] p-8">
                        <h3 class="text-xl font-black text-warm-text dark:text-dark-text tracking-tighter mb-8 bg-terracotta/5 rounded-xl px-4 py-1 inline-block">Vital Statistics</h3>
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-terracotta/5 border border-terracotta/20 group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Class Code</p>
                                        <p class="text-sm font-black text-warm-text dark:text-dark-text">{{ academicClass.code }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-2xl bg-terracotta/5 border border-terracotta/20 group">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p class="text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">Total Population</p>
                                        <p class="text-sm font-black text-warm-text dark:text-dark-text">~160 Students</p>
                                    </div>
                                </div>
                            </div>
                        </div>

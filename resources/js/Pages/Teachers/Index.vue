    ...
    <Sidebar>
        <template #header-title>
            <div class="flex items-center gap-2">
                ...
                <span class="font-black text-sm uppercase tracking-wider text-warm-muted dark:text-dark-muted">Faculty Directory</span>
            </div>
        </template>
        ...
        <div class="space-y-8 animate-fade-in-up">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    <h1 class="text-4xl font-black text-warm-text dark:text-dark-text tracking-tighter mb-2">Teachers</h1>
                            ...
                            <tr v-for="teacher in teachers.data" :key="teacher.id" class="group hover:bg-terracotta/5 transition-colors duration-300">
                                <td class="py-6 px-8">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="min-w-0">
                                            <p class="font-black text-warm-text dark:text-dark-text truncate tracking-tight text-lg mb-0.5">{{ teacher.user.name }}</p>
                                            <p class="text-[11px] font-mono font-bold text-warm-muted dark:text-dark-muted uppercase tracking-tighter">ID: {{ teacher.employee_id }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="py-6 px-8">
                                    <div class="flex flex-col gap-1.5">
                                        <Badge class="w-fit bg-terracotta/10 text-terracotta border-0 font-black text-[10px]">{{ teacher.specialization || 'Senior Educator' }}</Badge>
                                        <div class="flex items-center gap-1.5 text-[10px] font-black text-warm-muted dark:text-dark-muted uppercase tracking-widest">
                                ...
                                <td class="py-6 px-8">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex items-center gap-2 text-[11px] font-bold text-warm-muted dark:text-dark-muted">

    ...
    <Sidebar>
        <template #header-title>
            <div class="flex items-center gap-2">
                ...
                <span class="font-black text-sm uppercase tracking-wider text-warm-muted dark:text-dark-muted/80">Academic Hub</span>
            </div>
        </template>
            ...
            <div class="relative overflow-hidden card-warm rounded-3xl lg:rounded-[2.5rem] p-6 lg:p-12">
                ...
                <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 lg:gap-8">
                    <div class="flex items-center gap-4 lg:gap-6">
                        ...
                        <div>
                            <h1 class="text-3xl lg:text-5xl font-black text-warm-text dark:text-dark-text mb-2 tracking-tighter">
                    ...
                    <div class="flex flex-col items-start md:items-end">
                        <div class="bg-white/50 dark:bg-dark-bg/50 px-4 lg:px-6 py-2 lg:py-3 rounded-2xl border border-terracotta/20 text-left md:text-right">
                            ...
                            <p class="font-bold text-warm-text dark:text-dark-text">
                ...
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
                        <div class="card-warm p-6 rounded-3xl lg:rounded-[2rem] group cursor-pointer hover:border-terracotta/30 transition-all duration-300">
                            ...
                            <p class="text-xs font-black uppercase tracking-widest text-warm-muted dark:text-dark-muted/80 mb-1">My Classes</p>
                            <h3 class="text-4xl font-black text-warm-text dark:text-dark-text tracking-tighter">{{ stats?.classes || 8 }}</h3>
                        </div>
                        ...
                        <div class="card-warm p-6 rounded-3xl lg:rounded-[2rem] group cursor-pointer hover:border-terracotta/30 transition-all duration-300">
                            ...
                            <p class="text-xs font-black uppercase tracking-widest text-warm-muted dark:text-dark-muted/80 mb-1">Students</p>
                            <h3 class="text-4xl font-black text-warm-text dark:text-dark-text tracking-tighter">{{ stats?.students || 156 }}</h3>
                        </div>
                        ...
                        <div class="card-warm p-6 rounded-3xl lg:rounded-[2rem] group cursor-pointer hover:border-amber/30 transition-all duration-300">
                            ...
                            <p class="text-xs font-black uppercase tracking-widest text-warm-muted dark:text-dark-muted/80 mb-1">Tasks</p>
                            <h3 class="text-4xl font-black text-warm-text dark:text-dark-text tracking-tighter">15</h3>
                        </div>
                    </div>
                            ...
                            >
                                <div class="flex flex-col md:flex-row md:items-center gap-4 lg:gap-6">
                                    <div class="flex-shrink-0 w-24 md:text-center flex md:block items-center gap-2">
                                        <div class="text-2xl lg:text-3xl font-black text-warm-text dark:text-dark-text">{{ classItem.time.split(':')[0] }}</div>
                                        <div class="text-[10px] font-black uppercase text-warm-muted dark:text-dark-muted/80 tracking-widest">{{ classItem.time.split(' ')[1] }}</div>
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <div class="flex flex-wrap items-center gap-3 mb-2">
                                            <h4 class="text-lg lg:text-xl font-black text-warm-text dark:text-dark-text tracking-tight">{{ classItem.subject }}</h4>
                                            <Badge class="bg-terracotta/10 text-terracotta border-0 font-black">{{ classItem.class }}</Badge>
                                        </div>
                                        <div class="flex flex-wrap items-center gap-4 text-xs lg:text-sm text-warm-muted dark:text-dark-muted font-medium">
                ...
                <div class="lg:col-span-4 space-y-6 lg:space-y-8">
                    ...
                    <div class="card-warm rounded-3xl lg:rounded-[2.5rem] p-6 lg:p-8">
                        <div class="flex items-center justify-between mb-8">
                            <h3 class="text-2xl font-black text-warm-text dark:text-dark-text tracking-tighter">Academic Tasks</h3>
                        ...
                        <div class="space-y-4">
                            <div v-for="task in pendingTasks" :key="task.title" :class="['p-4 rounded-2xl border transition-all lg:hover:scale-[1.02]', task.color]">
                                <div class="flex items-center justify-between mb-2">
                                    <h4 class="text-sm font-black tracking-tight text-warm-text dark:text-dark-text">{{ task.title }}</h4>
                                    <Badge class="bg-white/50 dark:bg-dark-bg/50 border-0 font-black text-warm-text dark:text-dark-text">{{ task.count }}</Badge>
                                </div>
                                <div class="text-[10px] font-black uppercase tracking-widest opacity-60">{{ task.priority }} PRIORITY</div>
                            </div>
                        </div>
                        <Button variant="ghost" class="w-full mt-6 rounded-2xl border-dashed border-terracotta/20 text-warm-muted dark:text-dark-muted font-bold h-12 hover:text-terracotta">
                        ...
                        <div class="space-y-6">
                            <div>
                                <div class="flex justify-between mb-2">
                                    <span class="text-xs font-black text-warm-muted dark:text-dark-muted/80 uppercase">Attendance Analytics</span>
                            ...
                            <div>
                                <div class="flex justify-between mb-2">
                                    <span class="text-xs font-black text-warm-muted dark:text-dark-muted/80 uppercase">Avg. Academic Score</span>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-8">
                                <div class="p-4 bg-terracotta/5 rounded-2xl text-center border border-terracotta/20">
                                    ...
                                    <p class="text-xl font-black text-warm-text dark:text-dark-text">4.8/5.0</p>
                                </div>
                                <div class="p-4 bg-forest/5 rounded-2xl text-center border border-forest/20">
                                    ...
                                    <p class="text-xl font-black text-warm-text dark:text-dark-text">92%</p>
                                </div>
                            </div>
                        </div>
                    </div>
